...
const pinNumberr = document.getElementById('pin-number').value;
// console.log(phoneNumber, pinNumberr);


// bad way to validate 
if(phoneNumber === '66' && pinNumberr ==='1234'){
  // console.log('you are loging');
  // window.location.href ="homes.html";
window.location.href = 'homes.html'
}
else{
alert('worng number, please enter youre phone number')
}
